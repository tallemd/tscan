            ...
            else
            {
                ...
                if (args.Count() > 0)
                {
                    foreach (String arg in args)
                    {
                        ...
                        else if (arg.StartsWith("//MAC", StringComparison.CurrentCultureIgnoreCase))
                        {
                            Scan.MACLookupURI= arg.Split(":".ToCharArray())[1];
                        }
                        else if (arg.StartsWith("//Element", StringComparison.CurrentCultureIgnoreCase))
                        {
                            Scan.XMLElements = arg.Split(":".ToCharArray())[1].Split(",".ToCharArray());
                        }
                    }
